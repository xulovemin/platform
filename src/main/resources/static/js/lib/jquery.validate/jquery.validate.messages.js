...
jQuery.validator.addMethod("username",function(value, element) {
	return this.optional(element) || /^[a-zA-Z0-9][a-zA-Z0-9_]{1,19}$/.test(value);
},"2-20位字母或数字开头，允许字母数字下划线");
...
jQuery.validator.addMethod("mobile", function(value, element) {
    ...
    return this.optional(element) || (length == 11 && /^(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/.test(value));
}, "请输入有效的手机号码");
...
//只能输入英文
jQuery.validator.addMethod("englishNum", function(value, element) {
